...
public class MainActivity extends Activity {
    ...
    Mat src, srcOrig;
    private static final String FILE_LOCATION = Environment.getExternalStorageDirectory() + "";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        Log.d("MainActivity", requestCode + " " + CLICK_PHOTO + " " + resultCode + " " + RESULT_OK);
    ...
    private void getPage(){
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                dialog = ProgressDialog.show(MainActivity.this, "Grabbing page", "Please Wait");
            }
            ...
            protected Bitmap doInBackground(Void... params) {
                ...
                Log.d("com.example.qiupenglin.independent_study", cornerPts.checkVector(2, CvType.CV_32F)+" "+resultPts.checkVector(2, CvType.CV_32F)+" "+CvType.CV_32F+" "+cornerPts.type());
